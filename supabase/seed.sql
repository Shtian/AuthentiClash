...
(22, NOW(), 'Participation Award', 'Milestone: 5 games without win or loss', TRUE, FALSE, 'participation-award', NULL, 22),
(23, NOW(), 'Aggressively Average', 'Milestone: 10 games without win or loss', TRUE, FALSE, 'aggressively-average', NULL, 23),
(24, NOW(), 'Lean Mean Authenticlash Machine', 'Milestone: 20 games without win or loss', TRUE, FALSE, 'lean-mean-authenticlash-machine', NULL, 24),
(25, NOW(), 'Wouldn''t Stick Out In A Crowd Of One', 'Milestone: 50 games without win or loss', TRUE, FALSE, 'wouldnt-stick-out-in-a-crowd-of-one', NULL, 25),
(26, NOW(), 'Lucky In Love', 'Ended a game with four or more scores all under 50', TRUE, TRUE, 'lucky-in-love', NULL, 26),
(27, NOW(), 'Literally Can''t Believe It', 'Ended a game with four or more scores all above 50', TRUE, TRUE, 'literally-cant-believe-it', NULL, 27);