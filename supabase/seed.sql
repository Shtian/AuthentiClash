...
(22, NOW(), 'Participation Award', 'Milestone: 5 games without win or loss', TRUE, FALSE, 'participation-award', 'https://mzuhtoiuhpkczppcdwza.supabase.co/storage/v1/object/public/badges/participation-award.webp', 22),
(23, NOW(), 'Aggressively Average', 'Milestone: 10 games without win or loss', TRUE, FALSE, 'aggressively-average', 'https://mzuhtoiuhpkczppcdwza.supabase.co/storage/v1/object/public/badges/aggressively-average.webp', 23),
(24, NOW(), 'Lean Mean AuthentiClash Machine', 'Milestone: 20 games without win or loss', TRUE, FALSE, 'lean-mean-authenticlash-machine', 'https://mzuhtoiuhpkczppcdwza.supabase.co/storage/v1/object/public/badges/lean-mean-authenticlash-machine.webp', 24),
(25, NOW(), 'Wouldn''t Stick Out In A Crowd Of One', 'Milestone: 50 games without win or loss', TRUE, FALSE, 'wouldnt-stick-out-in-a-crowd-of-one', 'https://mzuhtoiuhpkczppcdwza.supabase.co/storage/v1/object/public/badges/wouldnt-stick-out-in-a-crowd-of-one.webp', 25),
(26, NOW(), 'Lucky In Love', 'Ended a game with four or more scores all under 50', TRUE, TRUE, 'lucky-in-love', 'https://mzuhtoiuhpkczppcdwza.supabase.co/storage/v1/object/public/badges/lucky-in-love.webp', 26),
(27, NOW(), 'Literally Can''t Believe It', 'Ended a game with four or more scores all above 50', TRUE, TRUE, 'literally-cant-believe-it', 'https://mzuhtoiuhpkczppcdwza.supabase.co/storage/v1/object/public/badges/literally-cant-believe-it.webp', 27);