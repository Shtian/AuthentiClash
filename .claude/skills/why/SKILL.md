...
Before spawning investigators, list the MCP servers available in this session. An investigator with no MCP-backed source falls back to code archaeology and git history.
...
- `model`: `sonnet`
- Instruct investigators not to modify files.
