...
3. Plan the fix. If it crosses a function boundary, `architect` first. Delegate implementation to a subagent (omit `model`, inherit the parent chat model) with a specific scope. Review the diff.
